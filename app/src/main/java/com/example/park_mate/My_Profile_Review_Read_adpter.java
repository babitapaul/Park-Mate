...
public class My_Profile_Review_Read_adpter extends RecyclerView.Adapter<My_Profile_Review_Read_adpter.MyviewHolders> {

    Context context;
    ArrayList<ProfileReview> profileReviews;
    Session st;
    public My_Profile_Review_Read_adpter(Context c, ArrayList<ProfileReview> u) {
        context = c;
        profileReviews = u;
    ...
    @NonNull
    @Override
    public My_Profile_Review_Read_adpter.MyviewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new My_Profile_Review_Read_adpter.MyviewHolders(LayoutInflater.from(context).inflate(R.layout.my_review_readlist_layout, parent, false));

    }

    @Override
    public void onBindViewHolder(@NonNull final My_Profile_Review_Read_adpter.MyviewHolders holder, final int position) {
