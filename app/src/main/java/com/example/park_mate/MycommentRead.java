...
public class MycommentRead extends AppCompatActivity {
    ...
    My_Comment_Read_Wallpost_TimeLine_List_adpater comment_read_wallpost_timeLine_list_adpater;
    private DatabaseReference databaserefrence;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mycomment_read);
    ...
    void fetchcomment()
    {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                comment_read_wallpost_timeLine_list_adpater=new My_Comment_Read_Wallpost_TimeLine_List_adpater(getApplicationContext(),sjs);
