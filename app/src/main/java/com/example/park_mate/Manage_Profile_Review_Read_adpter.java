...
public class Manage_Profile_Review_Read_adpter extends RecyclerView.Adapter<Manage_Profile_Review_Read_adpter.MyviewHolders> {

    Context context;
    ArrayList<ProfileReview> profileReviews;
    Session st;
    public Manage_Profile_Review_Read_adpter(Context c, ArrayList<ProfileReview> u) {
        context = c;
        profileReviews = u;
    ...
    @NonNull
    @Override
    public Manage_Profile_Review_Read_adpter.MyviewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Manage_Profile_Review_Read_adpter.MyviewHolders(LayoutInflater.from(context).inflate(R.layout.manage_review_read_layout, parent, false));

    }

    @Override
    public void onBindViewHolder(@NonNull final Manage_Profile_Review_Read_adpter.MyviewHolders holder, final int position) {
